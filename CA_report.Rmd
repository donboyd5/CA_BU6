...
p <- pdata %>%
  ...
  scale_x_continuous(breaks=seq(0, 100e3, 10e3), labels=label_comma(accuracy=1, prefix="$"), limits=c(0, 100e3)) +
  legend_none +
  caption_left
p
...
camod_fsl <- feols(lrppwagp ~ exp + exp2 + edattain + marstat + sex + rachisp + as.factor(year) | cowf,
