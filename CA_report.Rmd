...
```{r wages_acs_dots, include=TRUE, fig.width=6, fig.height=8}
...
ggsave(here::here("results", "statefe_bar.png"), plot=statefe_bar, width=10, height=8, scale=1.0)
...
ggsave(here::here("results", "lawclustfe_bar.png"), plot=lawclustfe_bar, width=10, height=8, scale=1.3)
...
ggsave(here::here("results", "caclusterfe_bar.png"), plot=caclusterfe_bar, width=10, height=12, scale=1.3)
...
# TX has negative!!
results %>%
  filter(stabbr=="TX", worker==1, tier=="newhire") %>%
