...
# Wages and salaries of correctional officers

## Comparisons of correctional officers' wages and salaries to other states
...
capt3 <- "Note: States with fewer than 50 observations were grouped togther."
capt <- paste0(capt1, "\n", capt2, "\n", capt3)
statefe_dots <- cfe %>%
  # filter(stabbr != "Other") %>%
...
## Comparisons of California state correctional officers' wages and salaries to those of other California workers
